...
void test_network(){
	...
	printf("[TEST] run: %f %f\n",network->output->neurons_list[0]->value,network->output->neurons_list[1]->value);
	network_run(network,input1);
	printf("[TEST] run: %f %f\n",network->output->neurons_list[0]->value,network->output->neurons_list[1]->value);
